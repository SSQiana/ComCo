    ...
    if args.model_name == 'EdgeBank':
        ...
        for run in range(args.num_runs):
            ...
            if args.model_name == 'TGAT':
                ...
                dynamic_backbone = ComCo(args.top_k, args.top_n, args.alpha, args.beta, args.ratio, train_node_ids=all_node_idx,node_raw_features=node_raw_features, edge_raw_features=edge_raw_features, neighbor_sampler=full_neighbor_sampler,
            ...
            # k = 32
            early_stopping.load_checkpoint(model,args.top_k,args.top_n, map_location='cpu')
